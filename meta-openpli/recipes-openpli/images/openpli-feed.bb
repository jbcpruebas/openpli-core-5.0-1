...
do_install() {
    ...
    for f in 7100s-feed.conf all-feed.conf bre2ze-feed.conf mips32el-feed.conf sf108-feed.conf sf3038-feed.conf
    do
    ...
    for f in bre2ze-neu.png bre2ze-neu.xml red1-neu.png red1-neu.xml rc_models-neu.cfg sf108-neu.xml sf3038-neu.xml sf108-neu.png sf3038-neu.png
    do
    ...
    for f in 7100s-neu.jpg ew7362-neu.jpg sf108-neu.jpg sf3038-neu.jpg
    do
    ...
    for f in 7100s-neu.html ew7362-neu.html sf108-neu.html sf3038-neu.html
    do
    ...
    for f in 7100s-neu.png ew7362-neu.png sf3038-neu.png sf108-neu.png
    do
